...
<template>
  <header>
    ...
    <nav class="navbar navbar-expand-md fixed-top my-1">
      <div class="container glass-effect-1 g-4 py-2 d-flex">
        <RouterLink class="navbar-brand" :to="{ name: 'home', hash: '#landing_start' }" active-class="active"><img
            src="@assets/logo.svg" class="" /></RouterLink>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse"
          aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse align-self-center" id="navbarCollapse">
          <ul class="navbar-nav mx-auto mb-2 mb-md-0">
            <div></div>
            <li class="nav-item">
              <RouterLink class="nav-link active" aria-current="page" :to="{ name: 'home', hash: '#landing_4steps' }"
                active-class="active">Инструкция</RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink class="nav-link active" active-class="active"
                :to="{ name: 'home', hash: '#landing_galleria' }">Готовые решения</RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink class="nav-link active" active-class="active" :to="{ name: 'home', hash: '#landing_QaA' }"
                tabindex="-1">Вопрос-ответ</RouterLink>
            </li>
          </ul>
          <form class="d-flex">
            <RouterLink class="btn btn-outline-success text-black bg-white px-3" to="/gensettings"
              active-class="active">
              Создать цветник
            </RouterLink>
          </form>
  ...
  <footer class="footer mt-5 py-3 fullWidthFooterBootstrapFix">
    <div class="container pt-2">
      <div class="row justify-content-between g-4 py-2 pb-3 row-cols-1 row-cols-lg-2 text-white">
            ...
            <div>
              <div class="d-flex align-items-center pb-2">
                <div class="flex-shrink-0">
                  <img src="@assets/img/logo-telegram.svg" alt="telegram-logo" />
                </div>
      ...
      <div
        ...
        <div class="col">
          <div class="row d-flex justify-content-center align-items-center">
            ...
            <div class="col d-flex flex-wrap justify-content-center align-items-center" style="height: 100%">
              <button class="text-black p-2 border-0 bg-transparent text-white" style="height: 100%"
                @click="dialogVisible = true">
                Designed by Freepik
              </button>
            </div>
            <Dialog v-model:visible="dialogVisible" dismissableMask="true" modal header="www.freepik.com"
              :style="{ width: '20vw' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }"
              class="block-darkgreen1 p-4 rounded border-2px-bshtr-green1">
              <p class="m-0">
                <a
                  href="https://ru.freepik.com/free-vector/gray-neural-network-illustration_3786363.htm#fromView=search&page=1&position=5&uuid=022660f5-adcf-4f0c-95db-ccb3e1b3869b">Изображение
                  от rawpixel.com на Freepik</a>
              </p>
            </Dialog>
          </div>
        </div>
